...
function pcards_register_settings() {
	$pcards_default_colours = [
		'type'			=> 'string',
		'default'		=> 'standard',
	];
	$pcards_default_style = [
		'type'			=> 'string',
		'default'		=> 'standard',
	];
	register_setting( 'pcards-group', 'pcards-font' );
	register_setting( 'pcards-group', 'pcards-suite-colours', $pcards_default_colours );
	register_setting( 'pcards-group', 'pcards-suite-style', $pcards_default_style );
